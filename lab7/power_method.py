...
def power_method(A: np.array, max_iter: int = 500000, eps: float = 1e-8):
    """
...
def check_with_library(n, eps=1e5):
    A = np.random.rand(n, n)
    A = A.T @ A
    _ , [eig, v] = time_eval(power_method, "My power method", 1, A)
...
check_with_library(100, 1e5)
check_with_library(1000, 1e5)
summary()
